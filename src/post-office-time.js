...
let engine,scene,camera,manifest,shadow,life;const components=[],materials=[],uniformKinds=new Set(['earlyTree','futureTree','grass','shrub','vehicle']);
